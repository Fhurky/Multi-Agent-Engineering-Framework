...
- Status: Accepted; superseded in part by [ADR-0019](0019-durable-intent-receipts-for-side-effects.md), by [ADR-0022](0022-unqualified-drain-closure.md), and by [ADR-0026](0026-blocked-drain-attach-and-unverified-closure-recovery.md), which replaces absent-closure recovery selection and makes invocation closure supersedable during recovery. Every other decision below stands.
- Date: 2026-08-05
