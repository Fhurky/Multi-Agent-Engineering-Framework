...
- Status: Accepted; extended by proposed [ADR-0042](0042-conditionally-authorized-post-gate-merge-executors.md) with a TASK-026-owned merge-result adapter while TASK-005 remains the sole delivery owner
- Date: 2026-08-05
