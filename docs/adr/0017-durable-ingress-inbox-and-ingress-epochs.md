...
- Status: Accepted; superseded in part by [ADR-0023](0023-immutable-ingress-entries-and-named-bootstrap-dispatch-contracts.md), which removes entry consumption state, closes append authority over typed principals, and replaces the bootstrap promptness claim with two named dispatch contracts. Every other decision below stands.
- Date: 2026-08-05
