...
| [0013](0013-single-decision-recovery-reconciliation.md) | Single-decision recovery reconciliation | Accepted; superseded in part by 0020 and 0030 | TASK-008, TASK-006 |
...
| [0019](0019-durable-intent-receipts-for-side-effects.md) | Durable-intent receipts for process and workspace side effects | Accepted; superseded in part by 0027 and 0028 | TASK-004, TASK-017, TASK-003, TASK-006 |
...
| [0021](0021-durable-ingress-module-and-the-eight-module-map.md) | The durable ingress module and the eight-module map | Accepted; superseded in part by 0029 | TASK-026, TASK-005, Orchestrator |
...
| [0024](0024-task-record-projection-contract.md) | Exact task-record projection contract | Accepted | TASK-007, TASK-005 |
| [0025](0025-result-effect-identity-in-the-event-union.md) | Result-effect identity in the event union | Accepted | TASK-003, TASK-006, TASK-008 |
...
| [0028](0028-nominal-store-issued-durable-append-receipts.md) | Nominal, store-issued durable append receipts | Accepted | TASK-003, TASK-004, TASK-017 |
| [0029](0029-ingress-delivery-ownership.md) | Scheduling-owned ingress delivery | Accepted | TASK-005, TASK-006, TASK-004 |
| [0030](0030-one-canonical-recovery-decision-input-domain.md) | One canonical recovery decision input domain | Accepted | TASK-008, TASK-006 |
| [0031](0031-pre-dispatch-ingress-observer-and-collector.md) | Pre-dispatch ingress observer and collector | Accepted | TASK-026, TASK-005, TASK-006 |

ADR-0001 through ADR-0010 were recorded under TASK-002. ADR-0011 through ADR-0016 were recorded under TASK-016. ADR-0017 through ADR-0022 were recorded under TASK-024. Independent reviews rejected each of those three architecture publications; their records remain authoring baselines, not approved architecture. ADR-0023 through ADR-0031 are the TASK-028 amendment for findings A-201 through A-208 and the approved HUMAN-002 contract. Their publication is reviewable architecture, not a passing gate; only TASK-029 may decide the lineage verdict.
