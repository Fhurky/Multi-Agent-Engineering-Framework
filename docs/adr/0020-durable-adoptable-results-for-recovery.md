...
- Status: Accepted; superseded in part by [ADR-0025](0025-result-effect-identity-in-the-event-union.md), which makes result-effect identity originate in `EffectIntentRecorded`, and by [ADR-0030](0030-one-canonical-recovery-decision-input-domain.md), which incorporates pending-result presence into the canonical input. Every other decision below stands.
- Date: 2026-08-05
