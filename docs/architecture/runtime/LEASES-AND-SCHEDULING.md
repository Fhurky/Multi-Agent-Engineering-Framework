...
Normative scheduling contract for the autonomous runtime. Produced under TASK-002 and amended under TASK-016, TASK-024, TASK-028, TASK-032, TASK-034, TASK-036, and TASK-040. Related decisions: [ADR-0005](../../adr/0005-time-bounded-leases-with-monotonic-fencing-tokens.md) and [ADR-0015](../../adr/0015-typed-scheduling-gate-and-activation-contracts.md), as amended by [ADR-0017](../../adr/0017-durable-ingress-inbox-and-ingress-epochs.md), [ADR-0018](../../adr/0018-publication-classes-and-gate-lineages.md), TASK-028 ADRs [0024](../../adr/0024-task-record-projection-contract.md), [0029](../../adr/0029-ingress-delivery-ownership.md), and [0031](../../adr/0031-pre-dispatch-ingress-observer-and-collector.md), [ADR-0032](../../adr/0032-lossless-task-record-source-and-projection.md), [ADR-0036](../../adr/0036-target-tree-derived-architecture-fixtures-and-lineage-integration.md), and proposed [ADR-0042](../../adr/0042-conditionally-authorized-post-gate-merge-executors.md). Implemented by TASK-005, over an inbox and collector implemented by TASK-026.

## Amendment register — TASK-040

TASK-040 adds no scheduling edge and changes no gate verdict. It re-enumerates the amendment's own target tree under ADR-0036 and states that a verified merge result reaches selection only through TASK-026 append and TASK-005 signal/observe/deliver. The new `LIN-INTEGRATION-AUTHORITY-REVIEW` pair is pending and independent of the closed eight-round `LIN-ARCH-REVIEW` cohort.
