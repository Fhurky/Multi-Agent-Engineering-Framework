...
Normative workspace contract for the autonomous runtime. Produced under TASK-016 and amended under TASK-024 and TASK-028. Related decisions: [ADR-0011](../../adr/0011-agent-workspace-lifecycle-module.md), as amended by [ADR-0019](../../adr/0019-durable-intent-receipts-for-side-effects.md), [ADR-0018](../../adr/0018-publication-classes-and-gate-lineages.md), and TASK-028 ADRs [0027](../../adr/0027-finalize-split-around-the-publication-append.md) and [0028](../../adr/0028-nominal-store-issued-durable-append-receipts.md). Implemented by TASK-017.
