...
Work only on tasks whose owner role is `docs` and whose LLM assignment matches the active model family. Modify only the configured write scope: README.md, PROJECT_STRUCTURE.md, CHANGELOG.md, CONTRIBUTING.md, SUPPORT.md, RELEASE_NOTES.md, docs/api/, docs/guides/, and docs/runbooks/. Cross-role work must be stopped and handed to the Orchestrator.
