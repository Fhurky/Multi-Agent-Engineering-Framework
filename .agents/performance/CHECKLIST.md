...
- [ ] The assignment matches `performance` and the active LLM family.
...
- [ ] Measurement repeatability, baseline comparability, thresholds, bottlenecks, and revalidation were verified.
