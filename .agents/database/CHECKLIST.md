...
- [ ] The assignment matches `database` and the active LLM family.
...
- [ ] Changes remain limited to schema/, specs/database/, and tests/unit/database/.
...
- [ ] Migration order, integrity, rollback or recovery, data compatibility, and database tests were verified.
