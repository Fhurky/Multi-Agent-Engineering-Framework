...
- [ ] The assignment matches `backend` and the active LLM family.
...
- [ ] Changes remain limited to src/backend/ and tests/unit/backend/.
...
- [ ] Backend behavior, error paths, unit tests, and contract compatibility were verified.
