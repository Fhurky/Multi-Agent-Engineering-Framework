...
- [ ] The assignment matches `security` and the active LLM family.
...
- [ ] Threat coverage, secret exposure, authorization, data protection, dependency risk, and remediation evidence were verified.
