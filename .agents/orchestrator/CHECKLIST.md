...
- [ ] The assignment matches `orchestrator` and the active LLM family.
...
- [ ] Changes remain limited to tasks/, .agents/ROUTING.md, and .agents/HANDOFF.md.
...
- [ ] Single ownership, dependency readiness, branch identity, worktree isolation, and required gates were verified.
